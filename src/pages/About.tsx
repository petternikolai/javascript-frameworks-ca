  ...
  return (
    <Box sx={{ maxWidth: 1000, margin: "auto", p: 2 }}>
      ...
      <Typography level="body-md">
        ReactCart is a modern, lightweight e-commerce solution built with React.
        We're passionate about creating seamless shopping experiences for both
      ...
      <Typography level="body-md">
        To provide a fast, intuitive, and customizable shopping cart system that
        empowers businesses of all sizes to thrive in the digital marketplace.
      </Typography>
      <Typography level="h2" sx={{ mt: 2, mb: 2 }}>
        Key Features
      </Typography>
      <List>
        ...
        <ListItem>
          <ListItemContent>
            <span style={{ fontWeight: "bold" }}>User-Friendly: </span>Intuitive
            interface for both shoppers and administrators
          </ListItemContent>
        </ListItem>
        <ListItem>
          <ListItemContent>
      ...
      <List>
        ...
        <ListItem>
          <ListItemContent>
            <span style={{ fontWeight: "bold" }}>Support: </span>Dedicated team
      ...
      <Typography level="body-md">Get started with ReactCart today!</Typography>
    </Box>
  );
}
